...
<div class="main-panel">
        ...
        <div class="table-wrapper">
            <div class="table-title">
                <div class="row">
					...
					<div class="col-sm-6">
						<a href="#addEmployeeModal" class="btn btn-success" data-toggle="modal"><i class="material-icons">&#xE147;</i> <span>Add New Produit</span></a>
            ...
            <table class="table table-striped table-hover" >
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{$four->produit_description }}</td>
                       <td>{{$four->produit_description }}</td>
                                                <td>
					 ...
					 @if($four->publication_status==1)
					   ...
					   @endif   
                        ...
                        <td>
                   <a href="{{URL::to('/edit_Produit/'.$four->id_produit)}}" class="edit" ><i class="material-icons" data-toggle="tooltip" title="Edit" >&#xE254;</i></a>
   <a  class="delete" href="{{URL::to('/delet_Produit/'.$four->id_produit)}}" id="delete">
                 ...
                 @if($four->publication_status==1)
                  ...
                  <a  class="update" href="{{URL::to('/unactive_Produit/'.$four->id_produit)}}" >
            ...
            <a  class="delete" href="{{URL::to('/active_Produit/'.$four->id_produit)}}" >
                                <i class="material-icons">
                                      thumb_down_alt
                      </i>  </a>		
    @endif							
	...
	<div id="addEmployeeModal" class="modal fade">
		<div class="modal-dialog">
			...
			{{csrf_field()}}
					...
					<div class="modal-header">						
						<h4 class="modal-title">Add Produit</h4>
	 ...
	 <?php
		...
		<small id="emailHelp" class="form-text text-muted">We'll never share your email with anyone else.</small>
			...
			<div class="form-group">
											<label >Prix</label>
	<input type="double" class="form-control" id="prix" placeholder="Enter Price" name="Prix">
					<small id="emailHelp" class="form-text text-muted">We'll never share your email with anyone else.</small>
										</div>
